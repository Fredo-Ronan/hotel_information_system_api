            ...
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Admin</a></span> <span
                            class="mr-2"><a href="rooms.html"></a></span> <span>Rooms Data</span></p>
                    <h1 class="mb-4 bread">Rooms Data</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="container" style="margin-top: 5rem; margin-bottom: 5rem;">
    <!-- DATA TABLE -->
    <h3 class="title-4 m-b-35">Rooms Data</h3>
    ...
    <div class="table-responsive table-responsive-data2">
        <table class="table table-data2">
            ...
            <tbody>
                @foreach($list_rooms as $index=>$room)
                <tr class="tr-shadow">
                    <td>
                        <label class="au-checkbox">
                            <input type="checkbox">
                    ...
                    <td>{{ $room['desc'] }}</td>
                    <td class="desc">{{ $room['available'] }}</td>
                    <td>
                        <span class="status--process">{{ $room['status'] }}</span>
                    </td>
