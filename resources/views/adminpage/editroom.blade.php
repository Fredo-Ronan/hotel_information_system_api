...
<div class="container">
    <div class="form-container">
        ...
        <form action="{{ url('/admin') }}">
            <input type="text" name="room_name" class="form-control" placeholder="Room Name" value="Luxury Room">
            <input type="text" name="available" class="form-control" placeholder="Available" value="20">
            <select class="form-control" name="status">
                <option disabled>Status</option>
                <option value="Aktif" selected>Aktif</option>
                <option value="Tidak Aktif">Tidak Aktif</option>
            </select>
            <input type="number" class="form-control" placeholder="Price" value="120.00">
