                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group" style="margin: 8px 0px 0px 5px;">
                            ...
                            <input type="tel" style="border-radius: 5px;" class="form-control" id="phone"
                                name="phone">
                        </div>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab2-tab" data-toggle="tab" href="#tab2"
                                            role="tab" aria-controls="tab2" aria-selected="false">Tranfer Bank</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                            ...
                            <div class="row ms-">
                                <div class="form-group col-4 " style="margin: 8px 0px 0px 15px;">
                                    <select class="form-control" style="border-radius: 5px;" id="bulan"
                                        name="bulan">
