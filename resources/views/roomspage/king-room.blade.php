            ...
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home</a></span> <span
                            class="mr-2"><a href="rooms.html">Rooms</a></span> <span>King Room</span></p>
                    <h1 class="mb-4 bread">King Room</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                        <h2 class="mb-4">King Room <span>- (2 Available rooms)</span></h2>
                        <p>Desain kamar yang elegan dan luas dengan view pilihan yang tidak semua kamar mendapatkannya.</p>
                        ...
                        <p>Anda dapat menjadi tamu hotel seperti seorang raja dengan memesan kamar hotel King Room ini.</p>
                    </div>
                    <div class="col-md-12 room-single ftco-animate mb-5 mt-4">
                        <h3 class="mb-4">Take A Tour</h3>
                        <div class="block-16">
                            <figure>
                                <img src="images/room-6.jpg" alt="Image placeholder" class="img-fluid">
