            ...
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home</a></span> <span
                            class="mr-2"><a href="rooms.html">Rooms</a></span> <span>Family Room</span></p>
                ...
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="single-slider owl-carousel">
                            ...
                            <div class="item">
                                <div class="room-img" style="background-image: url(images/room-8.jpg);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                        <h2 class="mb-4">Family Room <span>- (6 Available rooms)</span></h2>
                        <p>Tidak sekedar kamar saja, namun seperti rumah dan anda dapat melakukan aktivitas layaknya seperti rumah sendiri.</p>
                        ...
                        <p>Dengan luasnya kamar ini anda dapat membawa semua anggota keluarga anda untuk menginap di kamar Family Room ini.</p>
                    </div>
                    <div class="col-md-12 room-single ftco-animate mb-5 mt-4">
                        <h3 class="mb-4">Take A Tour</h3>
                        <div class="block-16">
                            <figure>
                                <img src="images/room-2.jpg" alt="Image placeholder" class="img-fluid">
