            ...
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home</a></span> <span
                            class="mr-2"><a href="rooms.html">Rooms</a></span> <span>Superior Room</span></p>
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                        <h2 class="mb-4">Superior Room <span>- (2 Available rooms)</span></h2>
                        <p>
                            Anda akan merasakan tipe kamar paling tinggi di hotel ini. Rasakan kemewahan yang tiada tanding.
                        </p>
                        <div class="d-md-flex mt-5 mb-5">
                            ...
                            <ul class="list ml-md-5">
                                <li><span>View:</span>Beach, Forest, Mountains, Wildlife</li>
                    ...
                    <div class="col-md-12 room-single ftco-animate mb-5 mt-4">
                        ...
                        <div class="block-16">
                            <figure>
                                <img src="images/room-5.jpg" alt="Image placeholder" class="img-fluid">
